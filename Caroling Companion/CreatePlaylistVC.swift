...
//        super.viewDidLoad()
//        print("the FOURTH one!! ----->>>> \(playlistF)")
...
//        let playlistRef = DataService.ds.REF_PLAYLISTS.child(self.playlistF.key).child(DBPlaylistString.songs).child(song.songKey)
//        
...
//            cell.configurePlaylistSongCell(song, indexPath: indexPath as NSIndexPath, playlistKey: playlistF.key)
//            return cell
//        } else {
//            print("error")
...
//        
//        let playlistRef = DataService.ds.REF_PLAYLISTS.child(self.playlistF.key).child(DBPlaylistString.title)
//        
//        playlistRef.observeSingleEvent(of: .value, with: { (snapshot) in
//            if let _ = snapshot.value as? NSNull {
//                DataService.ds.REF_PLAYLISTS.child(self.playlistF.key).removeValue()
//            }
//        })
